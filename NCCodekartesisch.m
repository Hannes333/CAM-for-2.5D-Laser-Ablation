function varargout = NCCodekartesisch(varargin)
% Dies ist das Skript zum Fenster NCCodekartesisch.fig
% In diesem Code werden alle Eingaben die auf dem nccodekartesisch.fig getätigt
% werden ausgewertet.
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @NCCodekartesisch_OpeningFcn, ...
                   'gui_OutputFcn',  @NCCodekartesisch_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before NCCodekartesisch is made visible.
function NCCodekartesisch_OpeningFcn(hObject, eventdata, handles, varargin)
global Var
%Falls der Pfad mit Titel (Titelpfad) leer ist, wird Button2 ausgegraut
if isempty(Var.Titelpfad)
...
% Choose default command line output for NCCodekartesisch
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes NCCodekartesisch wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = NCCodekartesisch_OutputFcn(hObject, eventdata, handles) 
...
if ischar(FolderName);
    Titelpfad=[FolderName,'\',Var.Titel,'.txt'];
    Var.Titelpfad=Titelpfad;
...
F50_NCCode(Var.Schraffuren,Var.Stloben,Var.Schichtdicke,Var.Titelpfad,Var.UmrandungKonturen,Var.NCText );
close(NCCodekartesisch)
