...
SchraffurSkywritestart=0.1; %Skywrite zur Beschleunigung der Spiegel und Galvamotoren [µs]
SchraffurSkywriteend=0.1; %Skywrite zur Abbremsung der Spiegel und Galvamotoren [µs]
...
if ischar(FileName) && ischar(PathName)
    ...
    FD2StlObjekt(1,fv1,[0.2 0.2 0.8]);
    ...
    FD2StlObjekt(1,fv2,[0.2 0.8 0.8]);
...
%Wird ausgeführt nach Benutzung von  checkbox7 (Skywrite)
...
cla %Grafik zurücksetzen
FD2StlObjekt(1,Var.fv2,[0.2 0.8 0.8]);
camlight(20,225); %Lichtquelle hinzufügen
...
[Konturen0]=F11_Slicing( fv2.faces,fv2.vertices,Schnitthoehen,Schichtdicke );
...
FD2Schnittkontur(1,d,Konturen0);
...
cla %Grafik zurücksetzen
FD2StlObjekt(DStlObjekt1,Var.fv1,[0.2 0.2 0.8]);
FD2StlObjekt(DStlObjekt2,Var.fv2,[0.2 0.8 0.8]);
camlight(20,225); %Lichtquelle hinzufügen
if DKontur==1
    FD2Schnittkontur(DKontur,d,Var.Konturen0);
end
if DSchraffur==1
    FD2Schraffur(DSchraffur,d,Var.Schraffuren);
end
